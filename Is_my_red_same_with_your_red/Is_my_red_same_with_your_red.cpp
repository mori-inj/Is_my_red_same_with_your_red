...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int nCmdShow)
{
	...
	hWnd = CreateWindow(
		...
		GetSystemMetrics(SM_CXFULLSCREEN) / 2 - WINDOW_WIDTH/2,
		GetSystemMetrics(SM_CYFULLSCREEN) / 2 - WINDOW_HEIGHT/2,
		WINDOW_WIDTH,
		WINDOW_HEIGHT,
		NULL,
		NULL,
...
void OnPaintA(HDC hdc, int ID, int x, int y, double alpha)
{
	...
	{
		0.8f, 0.15f, 0.15f, 0.0f, 0.0f,
		0.2f, 0.75f, 0.15f, 0.0f, 0.0f,
		0.21f, 5.0f, 0.79f, 0.0f, 0.0f,
